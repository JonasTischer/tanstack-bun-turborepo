...
import { Route as authenticatedWsDemoRouteImport } from './routes/(authenticated)/ws-demo'
...
const authenticatedWsDemoRoute = authenticatedWsDemoRouteImport.update({
  id: '/ws-demo',
  path: '/ws-demo',
...
export interface FileRoutesByFullPath {
  ...
  '/ws-demo': typeof authenticatedWsDemoRoute
...
export interface FileRoutesById {
  ...
  '/(authenticated)/ws-demo': typeof authenticatedWsDemoRoute
  '/api/auth/$': typeof ApiAuthSplatRoute
...
export interface FileRouteTypes {
  ...
  to: '/' | '/login' | '/signup' | '/ws-demo' | '/api/auth/$' | '/dashboard'
  id:
    | '__root__'
    | '/'
    | '/(auth-pages)'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/(authenticated)/ws-demo': {
      id: '/(authenticated)/ws-demo'
      path: '/ws-demo'
      fullPath: '/ws-demo'
      preLoaderRoute: typeof authenticatedWsDemoRouteImport
...
interface authenticatedRouteRouteChildren {
  ...
  authenticatedWsDemoRoute: typeof authenticatedWsDemoRoute
}

const authenticatedRouteRouteChildren: authenticatedRouteRouteChildren = {
  authenticatedDashboardRouteRoute:
    authenticatedDashboardRouteRouteWithChildren,
  authenticatedWsDemoRoute: authenticatedWsDemoRoute,
}
